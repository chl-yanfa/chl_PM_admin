...
public class Warehouse {
    ...
    private List<WarehouseFileDto> warehouseFileList;
	public String getId() {
		return id;
	}
	...
	public List<WarehouseFileDto> getWarehouseFileList() {
		return warehouseFileList==null?new ArrayList<WarehouseFileDto>():warehouseFileList;
	}
	public void setWarehouseFileList(List<WarehouseFileDto> warehouseFileList) {
		this.warehouseFileList = warehouseFileList;
	}

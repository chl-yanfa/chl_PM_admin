var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	renderRow: function(target, fields, frozen, rowIndex, rowData){
		...
		if (frozen && opts.rownumbers){
			...
			cc.push('<td class="datagrid-td-rownumber split-view-rownumber"><div class="datagrid-cell-rownumber">'+rownumber+'</div>');
			cc.push('<div style="text-align:center;height:16px;" class="datagrid-cell"><span class="datagrid-row-expander datagrid-row-expand" style="display:inline-block;width:16px;height:16px;cursor:pointer;"></span></div></td>');
		}
...
//
	...
	onAfterRender: function(target){
		...
		//调整表格宽度
//		if(!opts.fit){
//			panel.find("div.datagrid-view2").find("table.datagrid-htable,table.datagrid-btable").css("width","100%");
//		}
	}
});

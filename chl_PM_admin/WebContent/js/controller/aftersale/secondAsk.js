function addSecondAsk(){
	var auctionId = getParamValue("id");
	var ff = $('#secondAskForm input,#secondAskForm textarea').serialize();
    ...
    ff += "&fileIds=" +fileIds;
	$.post("../../aftersale/addSecondAsk",ff,function(res) {
		if(res.returnCode='000000'){
			$.messager.alert('提示', "提交二询成功",'info',function(){
        		var auctionId = getParamValue("id");
